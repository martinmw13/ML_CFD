...
In the near future, I plan to extend this repository by incorporating an autoencoder for dimensionality reduction and potentially training a Recurrent Neural Network (RNN) for estimating the Reynolds number (Re) from CFD simulation snapshots.
